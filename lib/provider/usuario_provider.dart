...
class UsuarioProvider extends ChangeNotifier {
  ...
  listarUsuarioFirestore() async {
    ...
    await usuarios.orderBy('nome').get().then((value) {
      for (var usr
          in value.docs as List<QueryDocumentSnapshot<Map<String, dynamic>>>) {
  ...
  Future<UsuarioFirebase?> getUsuario(String id) async {
    try {
      var usuario =
      ...
      return UsuarioFirebase(
        ...
        isCliente: usuario.data()?["isCliente"] ?? false,
      );
    } catch (e) {}
    return null;
  }
